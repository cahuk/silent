...
define('SILENT_PATH_CORE', SILENT_PATH_BASE . DIRECTORY_SEPARATOR . 'core' . DIRECTORY_SEPARATOR);
define('SILENT_PATH_APP', SILENT_PATH_BASE . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR);
...
class SilentAutoload
{
    ...
    protected $frameworkNameSpaces = [
        ...
        'silent\\app\\controllers\\' => SILENT_PATH_APP  . 'controllers',
